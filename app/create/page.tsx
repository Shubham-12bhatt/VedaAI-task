...
export default function CreateAssignmentPage() {
  ...
  const menuItems = [
    ...
    { name: "My Groups", icon: Users, active: false },
    { name: "Assignments", icon: FileText, active: true },
    { name: "AI Teacher's Toolkit", icon: Sliders, active: false },
    { name: "My Library", icon: History, active: false },
  ];
    ...
    <div className="flex flex-col h-full justify-between">
            ...
            return (
              ...
              >
                <Icon
                  size={18}
                  className={`shrink-0 ${
                    item.active ? "text-[#1F1F1F]" : "text-[#8E8E93]"
                  }`}
                />
                <span>{item.name}</span>
              </button>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="bg-[#F1F1F1] rounded-[16px] p-3.5 flex items-center gap-3 card-shadow hover:bg-[#EAEAEA] transition-colors duration-200 cursor-pointer">
          <div className="w-[44px] h-[44px] rounded-full overflow-hidden shrink-0 bg-orange-400">
            {/* Render generated Ape NFT avatar */}
            <img
              src="/avatar_ape.png"
          ...
          <div className="flex flex-col min-w-0">
            ...
            <span className="font-inter text-[12px] font-normal text-[#7E7E7E] leading-normal truncate">
              Bokaro Steel City
            </span>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen w-full bg-[#E2E2E2] flex items-center justify-center p-0 md:p-6 overflow-auto font-inter">
      {/* 1440px x 780px Desktop Canvas */}
      <div className="w-full min-h-screen md:min-h-0 md:w-[1440px] md:h-[780px] md:min-w-[1440px] md:max-h-[780px] bg-gradient-to-b from-[#EEEEEE] to-[#DADADA] md:rounded-[24px] shadow-2xl relative overflow-hidden flex flex-col md:flex-row p-3 gap-3">
        ...
        <div className="flex flex-col flex-1 h-full md:h-[756px] gap-[22px] min-w-0">
          {/* TOP NAVBAR */}
          <header className="w-full h-[56px] bg-white rounded-[16px] pl-6 pr-3 flex items-center justify-between navbar-shadow shrink-0">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="bg-[#F1F1F1] hover:bg-[#EAEAEA] p-1 pl-1.5 pr-3 h-[38px] rounded-full flex items-center gap-2.5 cursor-pointer transition-colors duration-200">
                <div className="w-[28px] h-[28px] rounded-full overflow-hidden shrink-0 bg-orange-400">
                  {/* Render generated John Doe avatar */}
                  <img
                    src="/avatar_man.png"
                    alt="John Doe Avatar"
                    className="w-full h-full object-cover"
                ...
                <span className="font-inter text-[14px] font-medium text-[#1F1F1F] leading-none shrink-0">
                  John Doe
                </span>
          ...
          <main className="w-full h-full md:h-[678px] flex flex-col items-center justify-center p-6 shrink-0 relative">
            <div className="flex flex-col items-center max-w-[480px] text-center">
              {/* Empty State SVG composition */}
              <EmptyStateIllustration className="animate-in fade-in zoom-in duration-300" />
              ...
              {/* Description */}
              <p className="mt-2.5 font-inter text-[14px] font-normal text-[#5E5E5E] leading-[21px] max-w-[440px]">
